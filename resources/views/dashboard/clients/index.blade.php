                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                               ...
                               {{--  @if (auth()->user()->hasPermission('create_clients'))
                                    ...
                                    <a href="{{ route ('dashboard.clients.create')}}" class="btn btn-primary" ><i class="fa fa-plus" >@lang('site.add')</i></a>
                            ...
                            @foreach($clients as $index=>$client)
                                ...
                                <tr>
                                    ...
                                    @if (auth()->user()->hasPermission('read_orders'))
                                        ...
                                        <a href="{{ route('dashboard.orders.index', ['client_id' => $client->id]) }}" class="btn btn-primary btn-sm">@lang('site.orders')</a>
                                    @else
                                        <a href="#" class="btn btn-primary btn-sm disabled">@lang('site.orders')</a>
                                    @endif
                                    </td>
                                    <td>
                                        @if (auth()->user()->hasPermission('update_clients'))

                                            <a href="{{ route('dashboard.clients.edit',['client_id' => $client->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
