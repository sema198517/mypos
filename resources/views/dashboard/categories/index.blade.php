                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('create_categories'))
                                    ...
                                    <a href="{{ route ('dashboard.categories.create')}}" class="btn btn-primary" ><i class="fa fa-plus" >@lang('site.add')</i></a>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($categories as $index=>$category)
                                ...
                                <tr>
                                    ...
                                    <th><a href="{{ route('dashboard.products.index', ['category_id' => $category->id]) }}" class="btn btn-info btn-sm" >@lang('site.related_products')</a></th>
