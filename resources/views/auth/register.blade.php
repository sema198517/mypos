    ...
    <div class="login-box-body">
        ...
        <form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
            ...
            @include('partials._errors')
                        ...
                        <div class="form-group row">
                            <label for="last_name" class="col-md-4 col-form-label text-md-right">@lang('site.last_name')</label>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">@lang('site.phone')</label>
            ...
            <div class="form-group">
                ...
                <img src="{{ asset('uploads/user_images/default.png') }}" style="width: 50px;" class="img-thumbnail image-preview" alt="">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">@lang('site.password_confirmation')</label>
